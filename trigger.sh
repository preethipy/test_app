...
docker run -v $HOME/config:/root/config -v $HOME/kubeconfig:/root/.kube -e REPO='https://github.com/devsecopscloset/closetserver -b $BRANCH' --name closet_start -d devsecopscloset/closet_start:demo
